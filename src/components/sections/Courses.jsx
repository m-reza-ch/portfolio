...
export const Courses = () => {
  ...
  return (
    <section
      id="courses"
      className="min-h-screen flex flex-col py-20 relative justify-center text-black dark:text-white bg-white dark:bg-zinc-950 transition-colors"
    >
      <RevealOnScroll>
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto px-4 grid gap-6 sm:grid-cols-2">
            ...
            hover:-translate-y-1 
            hover:border-violet-500/30 dark:hover:border-teal-500/30 
            hover:shadow-[0_2px_8px_rgba(139,92,246,0.2)] dark:hover:shadow-[0_2px_8px_rgba(20,158,149,0.2)]
            transition-all"
              >
                ...
                <ul className="space-y-4">
                  {category.items.map((course) => (
                    ...
                    >
                      <BookOpenCheck
                        size={20}
                        className="text-violet-500 dark:text-teal-500 flex-shrink-0"
                      />
                      <span>{course}</span>
                    </li>
                  ))}
