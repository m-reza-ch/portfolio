            ...
            {projectData.map((project, idx) => (
              <div
                ...
                className="flex flex-col justify-between border border-black/10 dark:border-white/10 rounded-lg p-6 backdrop-blur-md 
                  hover:-translate-y-1 hover:border-violet-500/30 dark:hover:border-blue-500/30 
                  hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] dark:hover:shadow-[0_2px_8px_rgba(37,99,235,0.2)] 
              ...
              >
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="bg-violet-600/20 dark:bg-blue-600/20 text-violet-700 dark:text-blue-300 px-2 py-0.5 rounded text-xs font-medium tracking-wide hover:bg-violet-500/20 dark:hover:bg-blue-500/20 hover:shadow-[0_2px_6px_rgba(139,92,246,0.1)] dark:hover:shadow-[0_2px_6px_rgba(37,99,235,0.1)] transition-all italic">
                    {project.type}
                  </span>
                </div>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.tech.map((tech) => (
                    <span
                      key={tech}
                      className="bg-violet-500/10 dark:bg-blue-500/10 text-violet-700 dark:text-blue-300 px-2 py-0.5 text-xs font-medium tracking-wide rounded-full hover:bg-violet-500/20 dark:hover:bg-blue-500/20 transition-all"
                    >
                      {tech}
                    </span>
                  ))}
